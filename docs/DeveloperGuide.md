...
* [3. Design](#3-design)
    ...
    + [3.2. Components](#32-components)
        - [3.2.1. User Interface](#321-user-interface-abner)
        - [3.2.2. Command Parser](#322-command-parser-brandon)
        - [3.2.3. Cheat Sheet Structure](#323-cheat-sheet-structure-aldo)
        - [3.2.4. Cheat Sheet Management](#324-cheat-sheet-management-adhy)
        - [3.2.5. Data Storage](#325-data-storage-theo)
* [4. Implementation](#4-implementation)
    + [4.1. Parsing of Data to Construct Commands](#41-parsing-of-data-to-construct-commands)
    + [4.2. Editing Feature](#42-editing-feature)
    + [4.3. Sorting Feature](#43-sorting-feature)
    + [4.4. Storage & Reading of Cheatsheet files](#44-storage--reading-of-cheatsheet-files)
    + [4.5. Colour coding for code snippet](#45-proposed-colour-coding-for-code-snippet)
